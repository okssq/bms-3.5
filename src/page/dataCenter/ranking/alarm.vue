<template>
    <div class="operation" v-loading="loading">
        ...
        <div class="dchart-tle">高危报警排行榜</div>
        <div class="hor_cplust">
            <div class="dcharts">
                <div id="dchart">
                    <ve-histogram 
                        width="100%"
...
export default{
        ...
        return {
            ...
            echartData:{
                tooltip: {
                    ...
                    formatter:'报警类型: {b0}<br />报警数/百公里: {c0}',
    ...
    methods:{
        ...
        ajax_search(data){
            ...
            _this.loading = true;
            _mm.request({ 
                url:'/basic/high_risk_warning_list.json', 
                data:data
            }).then((res)=>{
