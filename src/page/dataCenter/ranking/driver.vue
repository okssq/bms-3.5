<template>
    <div class="operation" v-loading="loading">
        ...
        <div class="dchart-tle">高危司机排行榜</div>
...
export default{
        ...
        return {
            ...
            DATA_tbProps:{
                ...
                title:[
                    ...
                    {name: "车牌号",type: "",prop: "k2",width: ""},
                    {name: "报警次数(次)",type: "",prop: "k3",width: ""},
                    {name: "行驶里程(公里)",type: "",prop: "k4",width: ""},
                    {name: "报警数/百公里",type: "",prop: "k5",width: ""},
                ],
                items:[],
                page:{
                    size :8,
            ...
            echartData:{
                tooltip: {
                    ...
                    formatter:'司机姓名: {b0}<br />报警数/百公里: {c0}',
    ...
    methods:{
        ...
        ajax_search(data){
            ...
            _this.loading = true;
            _mm.request({ 
                url:'/basic/high_risk_driver_list.json', 
                data:data
            }).then((res)=>{
...
<style scoped>
    ...
    .hor_cplust{display: flex;justify-content: stretch;}
    .hor_cplust>div{width: calc(50% - 5px);}
    
    .dcharts{width:50%; box-sizing:border-box;position: relative;display: flex;flex-direction: column;}
   
    #dchart{box-sizing:border-box;flex: 1;height: 468px;}
    .dTble{width: 50%;padding-left: 10px;overflow-y: auto;}
