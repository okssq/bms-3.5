<template>
    <div class="operation" v-loading="loading">
        ...
        <div class="dcharts">
            <div class="dchart-tle">停车统计图</div>
            <div class="dchart-unit"><span>停车次数（次）</span><span>停车时长(秒)</span></div>
            <div class="d-parking" >
                <ve-histogram 
                    width="100%"
                    height="100%"
    ...
    export default {
            ...
            return {
                ...
                DATA_tbProps: {
                    ...
                    opeations: [{
                        name: "详情",
                        evt: "seeEdit",
                        path: "/statistics-parking/detail"
                    }],
                    items: [],
                    page: {
                        size: 10,
        ...
        methods: {
            ...
            ajax_search(data) {
                ...
                _this.loading = true;
                _mm.request({
                    url: '/basic/vehicle_stop_list.json',
                    data: data
                }).then((res) => {
            ...
            EVT_expAll() {
                ...
                window.open("/sicp/basic/down_vehicle_stop_list.json"+'?'+$.param(data));
            },
            //渲染表格所需数据
            fn_TBList(res) {
                let _this = this;
